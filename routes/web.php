...
Route::group(['namespace' => 'App\Http\Controllers'], function()
{
    ...
    Route::group(['middleware' => ['auth']], function() {
        ...
        Route::get('/admin/menu/edit/{menu}', 'MenuController@edit')->name('menu.edit');
        Route::post('/admin/menu/update/{menu}', 'MenuController@update')->name('menu.update');
        Route::post('/admin/menu/delete/{menu}', 'MenuController@destroy')->name('menu.destroy');
        Route::post('/admin/menu/restore/{menu}', 'MenuController@restore')->name('menu.restore');
